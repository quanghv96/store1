...
Route::group(['namespace' => 'Site'], function () {
    ...
    Route::group([], function () {
        ...
        Route::get('customer/reset.html', 'CustomerController@reset')->name('site.customer.reset');
        Route::post('customer/reset.html', 'CustomerController@handleReset')->name('site.customer.handle_reset');
        ...
        Route::get('customer/regester.html', 'CustomerController@regester')->name('site.customer.regester')->middleware('guest');
        Route::get('customer/order-history.html', 'CustomerController@history')->name('site.customer.history');
        Route::post('customer/order-detail-history.html', 'CustomerController@historyDetail')->name('site.customer.history_detail');
