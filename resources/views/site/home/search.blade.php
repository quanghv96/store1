            ...
            <div class="slider-items-products">
                <div id="jtv-brand-logo-slider" class="product-flexslider hidden-buttons">
                    <div class="slider-items slider-width-col6">
                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/brand1.png') }}" alt="Brand Logo">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/brand2.png') }}" alt="Brand Logo">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/brand3.png') }}" alt="Brand Logo">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/brand4.png') }}" alt="Brand Logo">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/brand5.png') }}" alt="Brand Logo">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/brand6.png') }}" alt="Brand Logo">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/brand7.png') }}" alt="Brand Logo">
                            </a>
                        </div>
                        <div class="item">
                            <a>
                                <img src="{{ asset('source/bower_components/library/site/version4/images/brand8.png') }}" alt="Brand Logo">
                            </a>
                        </div>
                    </div>
                </div>
