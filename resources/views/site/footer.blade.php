                ...
                <div class="col-xs-12 col-lg-3 col-md-4 col-sm-6">
                    ...
                    <div class="payment-accept">
                        ...
                        <div class="payment-icon">
                            <img src="{{ asset('source/bower_components/library/site/version4/images/paypal.png') }}" alt="paypal">
                            <img src="{{ asset('source/bower_components/library/site/version4/images/visa.png') }}" alt="visa">
                            <img src="{{ asset('source/bower_components/library/site/version4/images/american-exp.png') }}" alt="american express">
                            <img src="{{ asset('source/bower_components/library/site/version4/images/mastercard.png') }}" alt="mastercard">
                        </div>
                    </div>
                </div>
            </div>
